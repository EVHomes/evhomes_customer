...
class NavratriOfferPopup extends StatefulWidget {
  const NavratriOfferPopup({Key? key}) : super(key: key);

  @override
  _NavratriOfferPopupState createState() => _NavratriOfferPopupState();
}

class _NavratriOfferPopupState extends State<NavratriOfferPopup> with TickerProviderStateMixin {
          ...
          builder: (context, child) {
            return Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    color: (_colorAnimation.value ?? Colors.orange[400])!.withOpacity(0.3),
                    blurRadius: 15,
                    spreadRadius: 5,
                  ),
                ],
